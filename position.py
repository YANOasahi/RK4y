...
def Position(x,y):
    ...
    y_diff2 = np.zeros(4)
    for i in range(4):
        x_diff2[i] = x-variables_position.magnet_pos_x[1][i]
        y_diff2[i] = y-variables_position.magnet_pos_y[1][i]
    ...
    y_diff3 = np.zeros(4)
    for i in range(4):
        x_diff3[i] = x-variables_position.magnet_pos_x[2][i]
        y_diff3[i] = y-variables_position.magnet_pos_y[2][i]
    ...
    y_diff4 = np.zeros(4)
    for i in range(4):
        x_diff4[i] = x-variables_position.magnet_pos_x[3][i]
        y_diff4[i] = y-variables_position.magnet_pos_y[3][i]
    ...
    y_diff5 = np.zeros(4)
    for i in range(4):
        x_diff5[i] = x-variables_position.magnet_pos_x[4][i]
        y_diff5[i] = y-variables_position.magnet_pos_y[4][i]
    ...
    y_diff6 = np.zeros(4)
    for i in range(4):
        x_diff6[i] = x-variables_position.magnet_pos_x[5][i]
        y_diff6[i] = y-variables_position.magnet_pos_y[5][i]
